...
### 1 Evaluasi model: akurasi, precision, recall
### 2 Confusion matrix: cara membaca dan menginterpretasikan
### 3 Ilustrasi Python: train-test split, confusion matrix dengan Scikit-learn
### 4 Metrik Evaluasi untuk Regresi
#### 4.1 MSE, RMSE, MAE, R²
#### 4.2 Kapan menggunakan metrik apa
### 5 Imbalanced Dataset Problem
#### 5.1 Apa itu class imbalance
#### 5.2 Mengapa akurasi bisa menyesatkan
#### 5.3 Pengenalan teknik handling (SMOTE, undersampling)
### 6 ROC Curve dan AUC
### 6.1 Konsep dasar True Positive Rate vs False Positive Rate
### 6.2 Interpretasi AUC score
### 7 Feature Importance
#### 7.1 Cara melihat fitur mana yang paling berpengaruh
#### 7.2 Interpretability model sederhana
### 8 Studi kasus terpadu