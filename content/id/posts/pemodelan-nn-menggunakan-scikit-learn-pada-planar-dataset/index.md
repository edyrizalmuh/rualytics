+++
date = '2026-03-11T15:57:53+08:00'
draft = false
title = 'Pemodelan Neural Network Menggunakan Scikit Learn pada Planar Dataset'
translationKey = "nn-planar"
languages = 'id'
tags = ['Neural Network']
featuredImage = "images/cell-5-output-1.png"
featuredImagePreview = "images/cell-5-output-1.png"
# series = ['Dasar-Dasar Jaringan Syaraf Tiruan']
categories = ['Tutorial']
seo_title = "Pemodelan Neural Network Scikit-Learn untuk Planar Dataset: Tutorial EDA, Training, dan Evaluasi"
seo_description = "Tutorial praktis membangun model Neural Network dengan Scikit-Learn untuk klasifikasi planar/flower dataset non-linear, meliputi generasi data, EDA, preprocessing, baseline Logistic Regression, MLPClassifier, GridSearchCV, evaluasi metrik komprehensif, dan visualisasi decision boundary"
+++
